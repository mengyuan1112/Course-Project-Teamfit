  ...
  return (
    <div className={classes.root}>
      <AppBar position="static">
        <Toolbar>
          <IconButton edge="end" className={classes.menuButton} color="white" aria-label="menu" onClick={ event => window.location.href = "/home" }>
            Home
          </IconButton>
          ...
          <IconButton edge="end" className={classes.menuButton} color="white" aria-label="menu" onClick={ event => window.location.href = "/login" }>
            Login            
          </IconButton>
        </Toolbar>
      </AppBar>
