...
from flaskr.model import News # figure out how to fix this for the news article_info fields
...
def get_news():
    ...
    data = newsapi.get_everything(q='health and fitness', language='en', page_size=4)
